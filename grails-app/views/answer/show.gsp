	...
	<body>
		...
		<div id="show-answer" class="content scaffold-show" role="main">
			...
			<ol class="property-list answer">
				...
				<li class="fieldcontain">
					<span id="pointsNumber-label" class="property-label"><g:message code="answer.pointsNumber.label" default="Points Number" /></span>
					
						<span class="property-value" aria-labelledby="pointsNumber-label"><g:fieldValue bean="${answerInstance}" field="pointsNumber"/></span>
