	...
	<body>
		...
		<div id="show-question" class="content scaffold-show" role="main">
			...
			<ol class="property-list question">
				...
				<li class="fieldcontain">
					<span id="videoUrl-label" class="property-label"><g:message code="question.videoUrl.label" default="Video Url" /></span>
					
						<span class="property-value" aria-labelledby="videoUrl-label"><g:fieldValue bean="${questionInstance}" field="videoUrl"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" controller="answer" action="create" id="${questionInstance?.id}">Add answer</g:link>
