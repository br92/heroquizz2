			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'quizz.description.label', default: 'Description')}" />
				...
				<g:each in="${quizzInstanceList}" status="i" var="quizzInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${quizzInstance.id}">${fieldValue(bean: quizzInstance, field: "name")}</g:link></td>
